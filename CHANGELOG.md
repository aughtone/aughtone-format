...
### Changed
- Maintenance release: internal repository and documentation housekeeping only. No functional or API changes from 3.1.1; the published artifact is behaviourally identical.
