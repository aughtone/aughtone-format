...
object CALocalDateFormats : StyledDateTimeFormats<LocalDate> {
    /** 1952-12-01 */
    override fun short(
        locale: Locale,
        timeZone: TimeZone?,
    ...
    override fun full(
        ...
        LocalDate.Format {
            ...
            // XXX We can't tell here what teh year is, and we can't make a formatter
            ...
            char(' ')
            chars(LocaleAwareEraNames.lookup(locale=locale).after)
