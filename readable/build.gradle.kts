...
kotlin {
    ...
    wasmJs {
        browser {
            ...
            commonWebpackConfig {
                outputModuleName = "aughtone-format-readable"
                outputFileName = "aughtone-format-readable.js"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "format-readable", version.toString())
