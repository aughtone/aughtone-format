...
private val directionsMap = mapOf(
    ...
    "da" to listOf("N", "NØ", "Ø", "SØ", "S", "SV", "V", "NV"),
    "nb" to listOf("N", "NØ", "Ø", "SØ", "S", "SV", "V", "NV"),
    "nn" to listOf("N", "NØ", "Ø", "SØ", "S", "SV", "V", "NV"),
    "sv" to listOf("N", "NO", "O", "SO", "S", "SV", "V", "NV"),
    ...
    "hy" to listOf("Հս", "Հս-Արլ", "Արլ", "Հվ-Արլ", "Հվ", "Հվ-Արմ", "Արմ", "Հս-Արմ"),
    "ka" to listOf("ჩრდ", "ჩრდ-აღმ", "აღმ", "სამხ-აღმ", "სამხ", "სამხ-დას", "დას", "ჩრდ-დას"),
    ...
    "et" to listOf("P", "PK", "I", "KA", "L", "EL", "L", "LO"),
...
fun cardinalDirectionsFor(locale: Locale): List<String> {
    val fullTag =
        if (locale.regionCode != null) "${locale.languageCode}-${locale.regionCode}" else locale.languageCode
