...
kotlin {
    ...
    wasmJs {
        moduleName = "datetime-format-platform"
        browser {
            val rootDirPath = project.rootDir.path
            val projectDirPath = project.projectDir.path
            commonWebpackConfig {
                outputFileName = "datetime-format-platform.js"
...
//                api(libs.kotlinx.coroutines.core)
    ...
    compilerOptions {
        ...
        // moduleName = "io.github.aughtone.datetime.format.platform"
    }
...
compose.resources {
    publicResClass = true
    packageOfResClass = "io.github.aughtone.datetime.format.platform.resources"
    generateResClass = always
}

android {
    namespace = "io.github.aughtone.datetime.format.platform"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "datetime-format-platform", version.toString())
